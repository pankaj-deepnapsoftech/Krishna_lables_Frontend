        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-2xl font-roboto-slab font-bold text-white">Krishna Labels</span>
                <p className="text-sm text-gray-400 font-montserrat">Premium Manufacturing</p>
              </div>
            </div>
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <span className="text-xl font-roboto-slab font-semibold text-yellow-400">Quick Links</span>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link to={link.path} className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 font-poppins text-sm flex items-center group">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <span className="text-xl font-roboto-slab font-semibold text-yellow-400">Our Products</span>
            <ul className="space-y-3">
              {[
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <span className="text-xl font-roboto-slab font-semibold text-yellow-400">Contact Info</span>
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-700/50 transition-colors">
                ...
                <span className="text-gray-300 text-sm font-poppins">info@krishnalabels.com</span>
              </div>
              <div className="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-700/50 transition-colors">
                <Phone className="w-6 h-6 text-yellow-400 flex-shrink-0" />
                <span className="text-gray-300 text-sm font-poppins">+91 XXXXX XXXXX</span>
              </div>
              <div className="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-700/50 transition-colors">
                <Globe className="w-6 h-6 text-yellow-400 flex-shrink-0" />
                <span className="text-gray-300 text-sm font-poppins">Indian Subcontinent & Europe</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm font-poppins">
              © {new Date().getFullYear()} Krishna Labels. All rights reserved.
            </p>
            <p className="text-gray-400 text-sm font-poppins">
              Sister concern of <span className="text-yellow-400 font-medium">Dalmack Auto Electric Pvt. Ltd.</span>
            </p>
          </div>
        </motion.div>
      </div>
