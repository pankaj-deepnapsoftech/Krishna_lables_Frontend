 ...
 const navigate = useNavigate()
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="p-4 border-t absolute bottom-8 w-full border-slate-700 transition-all duration-500 ease-in-out">
          <Button
            variant="outline"
            className="w-full text-white bg-slate-800 hover:bg-slate-700 border-slate-600"
